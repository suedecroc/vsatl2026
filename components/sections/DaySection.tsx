          ...
          <div className="space-y-12 mt-12">
            {dayItinerary.map((day) => (
              <MotionWrapper key={day.day}>
                <article className="border border-dirty-orange/20 bg-charcoal/40 rounded-sm p-8 sm:p-12 lg:p-16 hover:border-dirty-orange/40 transition-colors duration-300">
                  <header className="text-center pb-8 mb-4 border-b border-cream/10">
                    <span className="inline-block px-4 py-1.5 font-[family-name:var(--font-display)] text-xs tracking-widest uppercase bg-dirty-orange text-midnight -skew-x-3">
                    ...
                    <h3 className="font-[family-name:var(--font-display)] text-2xl sm:text-3xl lg:text-4xl text-cream uppercase tracking-wide mt-5 neon-glow-orange">
                      {day.title}
                    </h3>
                  </header>
                  <div className="divide-y divide-cream/8">
